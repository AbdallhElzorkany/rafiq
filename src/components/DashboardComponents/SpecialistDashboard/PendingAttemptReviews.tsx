...
function ReviewCard({
  ...
  return (
    <div className="rounded-3xl border border-amber-200/70 bg-white shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
      ...
      {attempt.videoUrl && (
        <div className="px-5 pt-4 pb-2 border-b border-amber-100/80 bg-white">
        ...
        {!status ? (
          <div className="flex gap-2">
            <button
              ...
              className="cursor-pointer flex-1 inline-flex items-center justify-center gap-2 py-2.5 rounded-xl bg-green-600 text-white text-sm font-semibold hover:bg-green-700 active:scale-[0.99] transition-all shadow-sm shadow-green-200"
            >
            ...
            <button
              ...
              className="cursor-pointer flex-1 inline-flex items-center justify-center gap-2 py-2.5 rounded-xl bg-red-500 text-white text-sm font-semibold hover:bg-red-600 active:scale-[0.99] transition-all shadow-sm shadow-red-200"
            >
          ...
          <>
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={isPending}
                className={`cursor-pointer flex-1 inline-flex items-center justify-center gap-2 py-2.5 rounded-xl text-white text-sm font-semibold disabled:opacity-60 disabled:cursor-not-allowed ${
              ...
              <button
                ...
                disabled={isPending}
                className="cursor-pointer px-4 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-600 text-sm font-medium hover:bg-slate-50 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                Back
              </button>
            </div>
    ...
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
      <div className="flex items-start justify-between gap-3 mb-5">
        ...
        <button
          ...
          disabled={isFetching}
          className="cursor-pointer p-2 rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors disabled:opacity-50"
          title="Refresh"
        >
